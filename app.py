...
preprocess.text("Done with data pre-processing!!")
st.write(df.head())
...
col1 = st.sidebar.selectbox("First columns :",options=("deliveryin_min",'cost','ratings','order'))
col2 = st.sidebar.selectbox("Second columns :",options=("order",'cost','deliveryin_min','ratings'))
